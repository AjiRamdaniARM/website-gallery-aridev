    ...
    <div class="max-w-xs container bg-white rounded-xl shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
      ...
      <div>
        <div class="flex justify-center items-center gap-2">
            ...
            <span class="text-white text-xs flex font-bold rounded-lg bg-red-500 gap-2 py-1.5 px-4 cursor-pointer">
            ...
            <form  action="{{ route('dataImage.delete', $image->fotoID) }}" method="POST">
                ...
                @method('DELETE')
                <button type="submit">
                    <span class="text-white text-xs font-bold gap-1 rounded-lg flex bg-red-500  mt-4 ml-4 py-1.5 px-4 cursor-pointer">
